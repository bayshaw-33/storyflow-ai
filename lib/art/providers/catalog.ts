...
export const ART_MODEL_CATALOG: ArtModelDescriptor[] = [
  ...
  },
  {
    ...
    label: "MAI Image 2.5 · 文生图",
    provider: "atlas",
    capabilities: ["text-to-image"],
    recommendedFor: ["reference_sheet", "concept"],
    maxReferences: 0,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "mai-text",
  },
  {
    id: "microsoft/mai-image-2.5/edit",
    label: "MAI Image 2.5 · 图生图",
    provider: "atlas",
    capabilities: ["image-edit", "multi-reference"],
    recommendedFor: ["reference_sheet", "variant", "edit"],
    maxReferences: 10,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "mai-edit",
  },
  {
    id: "alibaba/wan-2.7-pro/text-to-image",
    label: "Wan 2.7 Pro · 文生图",
    provider: "atlas",
    capabilities: ["text-to-image"],
    recommendedFor: ["reference_sheet", "concept"],
    maxReferences: 0,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "wan-text",
  },
  {
    id: "qwen/qwen-image-2.0/text-to-image",
    label: "Qwen Image 2.0 · 文生图",
    provider: "atlas",
    capabilities: ["text-to-image"],
    recommendedFor: ["reference_sheet", "concept"],
    maxReferences: 0,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "qwen-text",
  },
  {
    id: "qwen/qwen-image-2.0/edit",
    label: "Qwen Image 2.0 · 图生图",
    provider: "atlas",
    capabilities: ["image-edit", "multi-reference"],
    recommendedFor: ["reference_sheet", "variant", "edit"],
    maxReferences: 10,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "qwen-edit",
  },
  {
    id: "qwen/qwen-image-2.0-pro/edit",
    label: "Qwen Image 2.0 Pro · 图生图",
    provider: "atlas",
    capabilities: ["image-edit", "multi-reference"],
    recommendedFor: ["reference_sheet", "variant", "edit"],
    maxReferences: 10,
  ...
  },
  {
    ...
    label: "Grok Imagine Quality · 文生图",
    provider: "atlas",
    capabilities: ["text-to-image"],
    recommendedFor: ["reference_sheet", "concept"],
    maxReferences: 0,
    aspectRatios: ["1:1", "4:3", "3:4", "16:9", "9:16"],
    atlasProfile: "grok-text",
  },
  {
    id: "bytedance/seedream-v5.0-lite/edit",
    label: "Seedream v5.0 Lite · 图生图",
    provider: "atlas",
    capabilities: ["image-edit", "multi-reference"],
    recommendedFor: ["reference_sheet", "variant", "edit"],
    maxReferences: 10,
