...
不再单独增加多模型、KK、市场或融资介绍屏。这些能力应在产品页、白皮书或实际交互中呈现，避免首页重新变成功能目录。
...
> Now, turn that idea into your next project.

英文说明：

> Start with an idea, a script, or material you already have.
