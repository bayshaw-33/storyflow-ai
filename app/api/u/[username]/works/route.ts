...
import { getUserWorks } from "@/lib/supabase/profile-queries";
...
/**
 * GET /api/u/[username]/works?cursor=xxx&limit=12
 * 作品分页。
 */
export async function GET(
  ...
  try {
    ...
    const result = await getUserWorks(client, profile.user_id, cursor, limit);
