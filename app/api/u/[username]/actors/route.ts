...
import { getUserActors } from "@/lib/supabase/profile-queries";
...
/**
 * GET /api/u/[username]/actors?cursor=xxx&limit=12
 * 演员分页。
 */
export async function GET(
  ...
  try {
    ...
    const result = await getUserActors(client, profile.user_id, cursor, limit);
