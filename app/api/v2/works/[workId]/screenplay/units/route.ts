/**
 * POST /api/v2/works/[workId]/screenplay/units — create a unit (free entry)
 * GET  /api/v2/works/[workId]/screenplay/units — list units
 * Phase 3 Task 3.3
 */
...
function errorResponse(error: unknown) {
  const classified = classifyServiceError(error, "screenplay-units");
