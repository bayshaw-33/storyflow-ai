...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await listUnifiedJobs({ fetcher: serviceFetch, userId: user.id, projectId: params.get("projectId"), jobType: params.get("jobType"), status: params.get("status") });
